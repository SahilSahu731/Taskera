                              ...
                              <div className="flex gap-3 flex-wrap">
                                {ROLES.map((role) => (
                                  ...
                                  >
                                    ...
                                    <span
                                      className={cn(
                                        "w-7 h-7 rounded-full  border-2 border-blue-300 flex items-center justify-center transition-all duration-300 hover:shadow-lg bg-blue-90 text-white",
                                        field.value === role &&
                                          "ring-2 ring-blue-500 bg-blue-600 ring-offset-2 "
                                      )}
                                    >
                                      {field.value === role && (
